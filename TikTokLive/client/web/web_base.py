...
class TikTokHTTPClient:
    ...
    async def im_fetch(self, client):
        # todo 大量请求时应修改 ttwid, msToken, device_id等
        cookies = {
            'tt_csrf_token': 'YbRvJOeX-Q3cUBo5vR1h2Q-JUdi-IfjJLd6Q',
            'ak_bmsc': '77CC58F2F4567405C23E141361047827~000000000000000000000000000000~',
            ...
            'ttwid': '1%7CdXcLHA1TVU3hhO97_Rx0SDmIiC702bzMrQOyzhx_PD0%7C1712461669%7Cc3e722ed281d817877dd288a019b5087ce4b00f684ca2e6cc0c1884a84f36d90',
            'csrf_session_id': '90ffdfa1bd108902d918ad8b9896fec8',
            'msToken': 'xc2BuZYGkihRQz_1C2S6a7HlNe1qycYE6Kcv7sr6XPDKn0ocBRJJZGXSstDUnSDW58LczNqcjQHeg7J7jOuxWRfxvsSOfdNbVk0I-AOC5GW_9qAxQPwo1S725k7lXSSV_KR_kgOENfu_fAOAKQ=='
        }
        headers = {
            'accept': '*/*',
        ...
        params = (
            ...
            ('version_code', '270000'),
            ('msToken', Signature.gen_tiktok_ms_token()),
        ...
        return await (client or self._httpx).get(url, headers=headers, cookies=cookies)
